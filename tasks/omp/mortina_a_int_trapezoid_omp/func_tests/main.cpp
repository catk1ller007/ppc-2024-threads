...
TEST(Parallel_mortina_a_int_trapizoid, Test_1) {
  ...
  // Create Task
  TestTaskSequentialMortinaIntegralTrapezoid testOmpTaskSequential(taskDataSeq, x_y_quadro);
  ...
  // Create Task
  TestOMPTaskParallelMortinaIntegralTrapezoid testOmpTaskParallel(taskDataPar, x_y_quadro);
...
TEST(Parallel_mortina_a_int_trapizoid, Test_2) {
  ...
  // Create Task
  TestOMPTaskParallelMortinaIntegralTrapezoid testOmpTaskParallel(taskDataPar, sin_cos);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(Parallel_mortina_a_int_trapizoid, Test_3) {
  ...
  // Create Task
  TestOMPTaskParallelMortinaIntegralTrapezoid testOmpTaskParallel(taskDataPar, x_mul_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(Parallel_mortina_a_int_trapizoid, Test_4) {
  ...
  // Create Task
  TestOMPTaskParallelMortinaIntegralTrapezoid testOmpTaskParallel(taskDataPar, x_mult_sinY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(Parallel_mortina_a_int_trapizoid, Test_5) {
  ...
  // Create Task
  TestOMPTaskParallelMortinaIntegralTrapezoid testOmpTaskParallel(taskDataPar, x_del_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
